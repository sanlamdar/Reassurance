rem - nom - Cessions_reglement.sql
...
select statproj, codeinte, exersini, numesini, intesini, numeregl, numelign, numetrai, exertrai, dateeffe, codtyptr, ordrappl, numesect, coderisq,
   codecate, intepoli, numepoli, codtypre, datesurv, datecomp, annetrai, peritrai, flaggene, flagannu, numeaven, catecomp, tauxcess, catereas, 
   anneproj, numeproj, sourprim, datetrai, dateregl, libbrare, libcatre_c, libcatre_r, codbrare, codeassu, raissoci, codebran, libebran, libecate,
   desitrai, reglbrut, montregl, montreco, mont_smp, montcapi, capibrut from vr_reglement_reassurance 
