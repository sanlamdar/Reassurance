...
select   statproj, numequit, numetrai, exertrai, dateeffe, codtyptr, numesect, numetran, coderisq, codecate, codeinte, flaggene,
flagannu, flagvali, annetrai, peritrai, tauxprim, taux_smp, catereas, catecomp, anneproj, numeproj, numepoli, numeaven, dateffqu, datechqu,
datetrai, nume_pmd, datecomp, codeassu, libbrare, libcatre_c, libcatre_r, codbrare, desitrai, libecate, libebran, codebran, raissoci, primbrut,
montprim, mont_smp, capibrut, montcapi, montcomm, montacce, accebrut, moncomaj
from vr_prime_reassurance where anneproj='&&Annee'     and peritrai = nvl(decode('&&periode','null','','&&periode'),peritrai)
